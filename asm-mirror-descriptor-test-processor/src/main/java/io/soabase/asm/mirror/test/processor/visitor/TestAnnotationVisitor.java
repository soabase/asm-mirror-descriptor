...
public class TestAnnotationVisitor extends AnnotationVisitor {
    ...
    public void visitEnum(String name, String descriptor, String value) {
        annotationDetails.add(name, Format.asDescriptorValue(descriptor, value));
    }
    ...
    public AnnotationVisitor visitAnnotation(String name, String descriptor) {
        return new GatheringAnnotationVisitor("", values -> annotationDetails.add(name, Format.asDescriptorValue(descriptor, values)));
    }
