...
import static io.soabase.asm.mirror.descriptor.test.processor.visitor.Format.asNameDescriptor;
...
public class GatheringAnnotationVisitor extends AnnotationVisitor {
    ...
    public void visitEnum(String name, String descriptor, String value) {
        values.add(parentName + name + ": " + asDescriptorValue(descriptor, value));
    }
    ...
    public AnnotationVisitor visitAnnotation(String name, String descriptor) {
        return new GatheringAnnotationVisitor(parentName + asNameDescriptor(name, descriptor), values::addAll);
    }
